...
public class RestExceptionHandler extends ResponseEntityExceptionHandler
{
    ...
    @ExceptionHandler(Expectation_Failed.class)
    public ResponseEntity<ErrorMessage> Expectation_failed(Expectation_Failed exception, WebRequest request)
    {
        logger.warn("" + HttpStatus.EXPECTATION_FAILED);
        return ResponseEntity.status(HttpStatus.EXPECTATION_FAILED)
                .body(new ErrorMessage(HttpStatus.EXPECTATION_FAILED, exception.getMessage()));
    }
}
